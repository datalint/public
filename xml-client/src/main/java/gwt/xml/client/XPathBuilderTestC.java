...
public class XPathBuilderTestC {
    ...
    public void testBuild() {
        ...
        assertEquals("xPath[@idRef='id1' or @idRef='id2']", xPathHasAnyAttributeValues("xPath", "idRef", "id1", "id2")
                .build());
        assertEquals("xPath[@idRef='id1' or @idRef='id2' or @idRef='id3']", xPathHasAnyAttributeValues("xPath", "idRef",
                "id1", "id2", "id3").build());

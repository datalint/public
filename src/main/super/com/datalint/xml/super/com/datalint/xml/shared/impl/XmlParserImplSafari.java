...
public class XmlParserImplSafari extends XmlParserImplStandard {
	...
	protected native JavaScriptObject parseImpl(String contents) /*-{
		var domParser = this.@com.datalint.xml.shared.impl.XmlParserImplStandard::domParser;
		...
		if (parseerrors.length > 0) {
			...
			if (err.parentNode.tagName == 'body') {
				@com.datalint.xml.shared.impl.XmlParserImplSafari::throwDOMParseException(Ljava/lang/String;)(err.childNodes[1].innerHTML);
			}
		}
		return result;
	}-*/;
